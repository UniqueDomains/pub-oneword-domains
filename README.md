# Available .PUB One-Word Domains (5,621,943)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C712%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C621%2C943%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **5,621,943 domains** on the canonical page below.

**Public extract:** 8,712 rows · **Live catalog:** 5,621,943 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/pub?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_pub_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/pub?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_pub_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./pub.csv">CSV</a> / <a href="./pub.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_pub_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_pub_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .PUB search](https://unique.domains/domains/tld/pub?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_pub_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .PUB search](https://unique.domains/domains/tld/pub?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_pub_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./pub.csv) or [Download JSON](./pub.json)
...
- `pub.csv` — public CSV extract (8,712 rows)
- `pub.json` — public JSON extract (8,712 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,712-row public sample | 5,621,943 live domains                           |
...
| unity.pub      | available | $47.99    | $52.99        | 70             | 41     | 5      | name.com                                                |
...
| http.pub       | resell    | —         | —             | 80             | 73     | 4      | Hosting Concepts B.V. d/b/a Registrar.eu                |
| digital.pub    | premium   | $1,250    | $1,250        | 100            | 50     | 7      | name.com                                                |
| conscious.pub  | available | $47.99    | $52.99        | 89             | 38     | 9      | name.com                                                |
| guess.pub      | resell    | —         | —             | 100            | 71     | 5      | Chengdu West Dimension Digital Technology Co., Ltd.     |
...
| hotel.pub      | premium   | $520      | $520          | 70             | 46     | 5      | namecheap                                               |
| garage.pub     | available | $47.99    | —             | 72             | 38     | 6      | name.com                                                |
| power.pub      | resell    | —         | —             | 98             | 64     | 5      | DNSPod, Inc.                                            |
...
> Unique Domains. *Available .PUB One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
