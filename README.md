# Available .PUB One-Word Domains (8,716)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C717%20rows-8250df">
...
Daily-updated dataset of available and resale .pub one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 8,717 rows · **Live catalog:** 8,716 domains
...
- `pub.csv` — public CSV extract (8,717 rows)
- `pub.json` — public JSON extract (8,717 rows)
...
| green.pub      | premium   | $520      | $520          | 108            | 45     | 5      | namecheap                                               |
...
| ----------------------- | ------------------------------------------------ |
| 8,717-row public sample | 8,716 live domains                               |
...
> Unique Domains. *Available .PUB One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
